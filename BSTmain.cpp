...
int main()
{
    ...
    cout << "Size: " << tree.size() << "\n";
    if ((it = tree.find(20)) != nullptr)
        cout << "Found " << it << endl;
    else cout << "No key 20\n";
    if ((it = tree.find(15)) != nullptr)
        cout << "Found " << it << endl;
    else cout << "No key 15\n";
    tree.print();
    if ((it = tree.remove(20)) != nullptr)
    ...
    tree.print();
    if ((it = tree.find(1000)) != nullptr)
        cout << "Found " << it << endl;
    else cout << "No key 1000\n";
    if ((it = tree.find(999)) != nullptr)
        cout << "Found " << it << endl;
    ...
    tree.print();
    if ((it = tree.remove(15)) != nullptr)
        cout << "Removed " << it << endl;
    else cout << "No key 15\n";
    tree.print();
    if ((it = tree.remove(151)) != nullptr)
        cout << "Removed " << it << endl;
